        ...
        {tab === 'photos' && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <div style={{
              ...
              // Remplace uniquement la section upload dans tab === 'photos'
// (le div "marginTop: 16px" qui contient le file picker et le bouton Publier)

<div style={{ marginTop: '16px', display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
  
  {/* Zone file picker — onClick UNIQUEMENT sur ce div */}
  <div
    style={{
  ...
  {/* Bouton Publier — totalement séparé du div file picker */}
  <motion.button
    type="button"                         // ← important : évite tout submit
    onClick={(e) => {
