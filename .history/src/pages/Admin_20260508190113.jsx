...
const [editingPhoto, setEditingPhoto] = useState(null); // { id, title, category }
  ...
  snap => setPhotos(
    snap.docs
      ...
      .filter(p => p.createdAt !== null) // ← ignore les docs en attente de timestamp
  ),
  () => {}
);
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div style={{
              ...
              <p style={{
                ...
                Les réservations envoyées via WhatsApp apparaissent ici  
              </p>
              ...
              {bookings.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '60px', color: '#8A7968', fontFamily: 'Jost, sans-serif' }}>
                  ...
                  <span style={{ fontSize: '12px', opacity: 0.6 }}>
                    Les clientes vous contactent via WhatsApp. 
                  </span>
                </div>
              ) : (
